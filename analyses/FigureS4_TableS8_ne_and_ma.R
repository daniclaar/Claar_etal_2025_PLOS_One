...
jpeg(filename="figures/FigureS4_betareg_1118nema_mapindex.jpg",width=9,height=8,units="in",res=300)
(p_mb1ne+p_mb2ne+p_mb3ne)/(p_mb1ma+p_mb2ma+p_mb3ma)
dev.off()

pdf(file="figures/FigureS4_betareg_1118nema_mapindex.pdf",width=9,height=7)
(p_mb1ne+p_mb2ne+p_mb3ne)/(p_mb1ma+p_mb2ma+p_mb3ma)
dev.off()
