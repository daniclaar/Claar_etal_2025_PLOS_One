...
p_SmithMinor <- COSTR_AQRES_ssta %>% 
  ...
  theme(legend.position = "none",
        ...
        axis.title.y=element_text(size=18), # added temp
        axis.title.x=element_text(size=18),plot.title = element_text(hjust = 0.5),
...
#### Testing 2 rows
daily_ssta_bysubbasin_2011_2018_COSTR <- p_Coast+
  scale_x_datetime(name="Year",
                   limits=c(as.POSIXct("2011-01-01",format="%Y-%m-%d"), 
                            as.POSIXct("2019-01-01",format="%Y-%m-%d")),
                   expand=c(0,0))+
...
jpeg(filename="figures/Figure2_bottomrow_daily_ssta_bysubbasin_2011_2018_COSTR.jpg",
     width = 15, height=4,units="in",res=300)
daily_ssta_bysubbasin_2011_2018_COSTR
dev.off()

daily_ssta_bysubbasin_2011_2018_AQRES <- p_SmithMinor+ scale_x_datetime(name="Year",
                                 limits=c(as.POSIXct("2011-01-01",format="%Y-%m-%d"), 
                                          as.POSIXct("2019-01-01",format="%Y-%m-%d")),
                                 expand=c(0,0))+
  p_Cypress+ scale_x_datetime(name="Year",
...
jpeg(filename="figures/Figure2_bottomrow_daily_ssta_bysubbasin_2011_2018_AQRES.jpg",
     width = 15, height=4,units="in",res=300)
daily_ssta_bysubbasin_2011_2018_AQRES
dev.off()
